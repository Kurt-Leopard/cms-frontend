...
const BlueprintForm = () => {
  ...
  const handleNestedFieldChange = (parentIndex, fieldIndex, e) => {
    ...
    // When the field type is "repeater," add a nested repeater field
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("blueprint", JSON.stringify(blueprintData));
    console.log(JSON.stringify(blueprintData, null, 2));
    alert("Your blueprint is created!");
    window.location.href = "http://localhost:3000/user/blueprint";
  };

  return (
    <div>
      <div className="sticky top-0 bg-white border-y p-4 text-sm font-medium">
        <h1 className="font-semibold text-gray-900">QuickPage</h1>
      </div>
      <div className="p-4">
        <button
          onClick={toggleForm}
            ...
            <div className="bg-white border p-4 rounded-lg text-sm font-medium">
              ...
              {parentFields.map((parent, parentIndex) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-700 font-medium mb-2 text-sm font-medium">
                      Title
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="mb-6 p-4 bg-white border rounded-md shadow-sm">
                    <h3 className="font-semibold text-gray-800 mb-4 text-sm font-medium">
                      Fields
                    </h3>
